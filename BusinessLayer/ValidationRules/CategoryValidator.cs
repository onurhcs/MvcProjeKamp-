...
namespace BusinessLayer.ValidationRules
{
    public class CategoryValidator : AbstractValidator<Category>
    {
        ...
        {
            RuleFor(x => x.CategoryName).NotEmpty().WithMessage("Kategori Adını Boş Geçeemsiniz");
            RuleFor(x => x.CategoryDescrition).NotEmpty().WithMessage("Açıklamayı Boş Geçemesiniz");
